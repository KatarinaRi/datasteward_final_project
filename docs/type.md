...
### Type and Range
 | Property | Value | | --- | --- | | Range | [MonitoringActivityType](MonitoringActivityType.md) | | Domain Of | [MonitoringActivity](MonitoringActivity.md) |
...
## Mappings
 | Mapping Type | Mapped Value | | ---  | ---  | | self | cenvo:type | | native | cenvo:type |
