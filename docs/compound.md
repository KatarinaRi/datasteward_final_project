...
### Type and Range
 | Property | Value | | --- | --- | | Range | [ChemicalCompound](ChemicalCompound.md) | | Domain Of | [MeasurementConcentration](MeasurementConcentration.md) |
...
## Mappings
 | Mapping Type | Mapped Value | | ---  | ---  | | self | cenvo:compound | | native | cenvo:compound |
