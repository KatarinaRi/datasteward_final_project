...
| Property | Value | | --- | --- | | Base | `str` | | Type URI | [xsd:string](http://www.w3.org/2001/XMLSchema#string) | | Representation | `str` |
...
## Mappings
 | Mapping Type | Mapped Value | | ---  | ---  | | self | xsd:string | | native | cenvo:jsonpointer |
