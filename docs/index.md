...
| [MeasurementBase](MeasurementBase.md) | Shared measurement slots common to all observation types |
| [MonitoringActivity](MonitoringActivity.md) | A research project or monitoring programme collecting environmental data on c... |
| [Observation](Observation.md) | Observation - concentration measurement or other parameter |
