...
_Environmental domain - sample type according to sampled matrix/ environmental compartment. _
...
permissible_values:
  Atmospheric:
    text: Atmospheric
    description: Atmospheric for air, particles, precipitation, dust;
  Aquatic:
    text: Aquatic
    description: Aquatic for water and sediment;
  Terrestrial:
    text: Terrestrial
    description: Terrestrial for soil;
  Biota:
    text: Biota
    description: Biota for animal and plant tissues;
