...
# Slot: data_handling_procedure_link 


_GUPRI linking to a document describing the data handling procedure_
...
## Mappings
 | Mapping Type | Mapped Value | | ---  | ---  | | self | cenvo:data_handling_procedure_link | | native | cenvo:data_handling_procedure_link |
