...
### Type and Range
 | Property | Value | | --- | --- | | Range | [Double](Double.md) | | Domain Of | [MeasurementConcentration](MeasurementConcentration.md) |
...
## Mappings
 | Mapping Type | Mapped Value | | ---  | ---  | | self | cenvo:loq | | native | cenvo:loq |
